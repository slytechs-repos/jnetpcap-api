 ...
 *
 */
public class NetPcapForeignInitializer extends ForeignInitializer<NetPcapForeignDowncall, NetPcapException> {
	...
	private static LibraryPolicy currentMissingSymbolsPolicy = NetPcapForeignInitializer::defaultPolicy;
	 ...
	 */
	public NetPcapForeignInitializer(Class<?> initializerClass) {
		super(
				initializerClass.toString(),
				NetPcapForeignDowncall::new,
				NetPcapForeignDowncall::new,
