...
import com.slytechs.jnetpcap.pro.ProcessorConfigurator;
...
public abstract class AbstractPacketReceiver
	 ...
	 */
	public interface PacketDispatcherFactory<T extends ProcessorConfigurator<T>> {
	 ...
	 */
	public AbstractPacketReceiver(PacketReceiver processedPacketSink, PacketDispatcher rawPacketsource) {
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#getCaptureStatistics()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#getDescriptorType()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#getDissector()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#getPacketWithNext()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#getPacketWithNextExtended()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#onNativeCallbackException(java.lang.Throwable,
	 *      int, int)
	 */
	@Override
	 ...
	 * @return the packet
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#processPacket(java.nio.ByteBuffer,
	 ...
	 * @return the packet
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#processPacket(java.lang.foreign.MemorySegment,
	 ...
	 * @param user  the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#receivePacketWithLoop(int,
	 *      com.slytechs.jnetpcap.pro.ProHandler.OfPacket, java.lang.Object)
	 */
	@Override
