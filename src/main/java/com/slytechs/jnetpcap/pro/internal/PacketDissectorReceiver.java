...
public class PacketDissectorReceiver
	...
	/**
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#onNativeCallbackException(java.lang.Throwable, int, int)
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetpcap.pro.internal.PacketReceiver#processPacket(java.nio.ByteBuffer, java.lang.foreign.MemorySegment, int, int, long)
	 */
	@Override
