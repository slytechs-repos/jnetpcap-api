...
import com.slytechs.jnetpcap.PcapProConfigurator;
import com.slytechs.jnetpcap.PcapPro.PcapProContext;
...
public abstract class AbstractPacketReceiver
	 ...
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#getCaptureStatistics()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#getDescriptorType()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#getDissector()
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#onNativeCallbackException(java.lang.Throwable,
	 *      int, int)
	 */
	@Override
	 ...
	 * @return the packet
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#processPacket(java.nio.ByteBuffer,
	 ...
	 * @param user  the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.internal.PacketReceiver#receivePacketWithLoop(int,
	 *      com.slytechs.jnetpcap.pro.PcapProHandler.OfPacket, java.lang.Object)
	 */
	@Override
