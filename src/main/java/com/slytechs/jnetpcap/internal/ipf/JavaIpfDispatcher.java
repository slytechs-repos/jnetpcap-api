...
public final class JavaIpfDispatcher extends AbstractPacketReceiver implements IpfDispatcher {
	 ...
	 * @param user  the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.internal.PacketDissectorReceiver#dispatchPacket(int,
	 ...
	 * @param user  the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.internal.PacketDissectorReceiver#loopPacket(int,
	 *      com.slytechs.jnetpcap.pro.PcapProHandler.OfPacket, java.lang.Object)
	 */
	@Override
