...
import com.slytechs.jnetpcap.IpfConfiguration;
import com.slytechs.jnetpcap.internal.PacketReceiverConfig;
...
public class IpfConfig extends PacketReceiverConfig implements IpfConfiguration {
	 ...
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enable(boolean)
	 */
	@Override
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableAttachComplete(boolean)
	 */
	@Override
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableAttachIncomplete(boolean)
	 */
	@Override
	 ...
	 * @param enable the enable
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enablePassthrough(boolean)
	 */
	@Override
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableSendComplete(boolean)
	 */
	@Override
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableFragments(boolean)
	 */
	@Override
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableSendIncomplete(boolean)
	 */
	@Override
	 ...
	 * @param enable the enable
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableReassembly(boolean)
	 */
	@Override
	 ...
	 * @param enable the enable
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#enableTracking(boolean)
	 */
	@Override
	 ...
	 * @see com.slytechs.jnetpcap.IpfConfiguration#isTimeoutOnLast()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnetpcap.IpfConfiguration#isPassthrough()
	 */
	@Override
	 ...
	 * @param unit the unit
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setBufferSize(long,
	 ...
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setTimeoutOnLast(boolean)
	 */
	@Override
	 ...
	 * @param unit the unit
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setMaxDgramSize(long,
	 *      com.slytechs.protocol.runtime.util.MemoryUnit)
	 */
	@Override
	 ...
	 * @param unit                 the unit
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setMaxFragmentCount(int)
	 */
	@Override
	 ...
	 * @param unit the unit
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setTableSize(long,
	 ...
	 * @param unit    the unit
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#setTimeout(long,
	 ...
	 *
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#usePacketTimesource()
	 */
	@Override
	 ...
	 *
	 * @return the ipf configuration
	 * @see com.slytechs.jnetpcap.IpfConfiguration#useSystemTimesource()
	 */
	@Override
