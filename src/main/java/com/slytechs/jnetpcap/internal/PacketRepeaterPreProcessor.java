...
import com.slytechs.jnetpcap.PacketRepeater;
...
public class PacketRepeaterPreProcessor extends AbstractPcapDispatcher implements PcapDispatcher {
	 ...
	 * @param user    the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.internal.AbstractPcapDispatcher#dispatchNative(int,
	 ...
	 * @param user    the user
	 * @return the int
	 * @see com.slytechs.jnetpcap.internal.AbstractPcapDispatcher#loopNative(int,
	 *      org.jnetpcap.PcapHandler.NativeCallback,
	 *      java.lang.foreign.MemorySegment)
	 */
	@Override
